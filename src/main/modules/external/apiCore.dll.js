...
const dllPath = getAssetPath('apiCore.dll');
...
const tmpDb = {
  ...
  getIPListByMAC: edge.func({
    assemblyFile: dllPath,
    typeName: 'apiCore.DBService.DeviceScanManagement',
    methodName: 'GetIPListByMAC',
  }),
  saveIPListByMAC: edge.func({
    assemblyFile: dllPath,
    typeName: 'apiCore.DBService.DeviceScanManagement',
    methodName: 'SaveIPListByMAC',
  }),
  deleteIPListByMAC: edge.func({
    assemblyFile: dllPath,
    typeName: 'apiCore.DBService.DeviceScanManagement',
    methodName: 'DeleteIPListByMAC',
  }),
  // Advanced settings
